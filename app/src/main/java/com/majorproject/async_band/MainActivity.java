...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button button_enableBT = findViewById(R.id.button_enableBT);
        Button button_displayPairedBT = findViewById(R.id.button_alreadyPairedBT);
        Button button_scanBT = findViewById(R.id.button_scanBT);
