...
public class AlreadyPairedAdapter extends ArrayAdapter<BluetoothObject>
{
    ...
    AlreadyPairedAdapter(Context context, ArrayList<BluetoothObject> arrayOfAlreadyPairedDevices)
    {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent)
    {
        ...
        TextView bt_name = rowView.findViewById(R.id.textview_bt_paired_name);
        TextView bt_address = rowView.findViewById(R.id.textview_bt_paired_address);
        TextView bt_bondState = rowView.findViewById(R.id.textview_bt_paired_bond_state);
        TextView bt_type = rowView.findViewById(R.id.textview_bt_paired_type);
